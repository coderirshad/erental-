          ...
          <div className='container-fluid shadow' style={{width:"90%", textAlign:"left"}}>
               ...
               <div className='row shadow-sm pt-3'>
                        <div class="accordion" id="accordionExample" style={{width:"100%"}}>
                                <div class="mb-3 bg-body rounded px-4 py-2">
                                <h2 class="accordion-header" id="headingOne">
                                    <button class="accordion-button" style={{fontSize:"20px"}} type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                                ...
                                <div class="mb-3 bg-body rounded px-4">
                                <h2 class="accordion-header" id="headingTwo">
                                    <button class="accordion-button collapsed py-4 " style={{fontSize:"20px"}} type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                ...
                                <h2 class="accordion-header" id="headingThree">
                                    <button class="accordion-button collapsed py-4" style={{fontSize:"20px"}}  type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">

                    ...
                    <div className="col-lg-3 col-md-0">
                        <div className="sidemenu">
                            ...
                            <ul className="list-unstyled gt-menu">
                                <li><a href=""><img src="images/m-cloth.png" alt=""/>Men's Clothing<i className="fa fa-angle-right"></i></a>
                                    <div className="mega-menu">
                                        <div className="row">
                                            ...
                                            <div className="col-md-12">
                                                <div className="mg-bnr">
                                                    <img src="images/ipn.png" alt=""/>
                                                    <div className="mg-content text-right">
                                                        <h4>Iphone</h4>
                                ...
                                <li><a href=""><img src="images/w-cloth.png" alt=""/>Women's Clothing<i className="fa fa-angle-right"></i></a>
                                    <div className="mega-menu">
                                        <div className="row">
                                            <div className="col-md-4">
                                                <div className="smartphone">
                                ...
                                <li><a href=""><img src="images/ele.png" alt=""/>Electronics<i className="fa fa-angle-right"></i></a>
                                    <div className="mega-menu">
                                        <div className="row">
                                            <div className="col-md-4">
                                                <div className="smartphone">
                    ...
                    <div className="col-lg-9 col-md-12">
                        <div className="main-menu">
                            <ul className="list-unstyled list-inline">
                                ...
                                <li className="list-inline-item"><a>PAGE'S <i className="fa fa-angle-down"></i></a>
                                    <ul className="dropdown list-unstyled">

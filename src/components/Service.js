...
const Service = () =>{
    return (
             <div className="Service dCenter">
                 <div className="service_width d-between">
                    <div className="service_box">
                        <div>
                          <img src="images/shorttermservice1.png" width={70} />
                        </div>
                        <h5>SHORT TERM ITEMS</h5>
                        <p>eRentals provides short term rental services and products mainly for events, functions, expo and exhibitions</p>
                    </div>
                    <div className="service_box">
                       <div>
                          <img src="images/betteroptionservice3.png" width={70} />
                        </div>
                        <h5>BETTER OPTIONS</h5>
                        <p>eRentals provides a wide range of categories, more product options, and better choices at affordable cost to customer</p>
                    </div>
                    <div className="service_box">
                        <div>
                          <img src="images/Timelydeliveryservice2.png" width={70} />
                        </div>
                        <h5>DELIVERY & SETUP</h5>
                        <p>eRentals provides timely product delivery along with setup and installation facility based on customer choice</p>
                    </div>
                 </div>
             </div>

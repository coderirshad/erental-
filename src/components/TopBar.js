                ...
                <div className="col-md-6">
                    <div className="top-right text-right">
                        <ul className="list-unstyled list-inline">
                            ...
                            <li className="list-inline-item"><a href="/registration"><img src="images/login.png" alt=""/>Registration</a></li>
                            <li className="list-inline-item"><a href="/aboutUs"><img src="images/user.png" alt=""/>AboutUs</a></li>
                        </ul>
                    </div>
                </div>
            </div>
